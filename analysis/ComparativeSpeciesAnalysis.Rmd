...
cort = corr_dat_atl_gaba$axolotl_mouse
...
write.csv(plot_df, 
           file = "results/ComparativeSpeciesAnalysis/GABA_all_axolotl_mouse_tab.csv", 
...
write.csv(cort$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/GABA_all_axolotl_turtle_genes.csv", 
          col.names = T, row.names = F, quote = F)
```
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/GABA_TFs_axolotl_turtle_tab.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(cort$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/GABA_TFs_axolotl_turtle_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/Glut_all_axolotl_turtle_tab.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(cort$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/Glut_all_axolotl_turtle_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/Glut_TFs_axolotl_turtle_tab.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(cort$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/Glut_TFs_axolotl_turtle_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
ct_sets = list("axolotl" = unique(meta_sp_l$axolotl$cellclusters[meta_sp_l$axolotl$subclasses=="Glutamatergic" &
                                                                   meta_sp_l$axolotl$cellclusters!="glut_SUBSET_23"]),
               "mouse" = unique(meta_sp_l$mouse$cellclusters[grepl("TEGLU", meta_sp_l$mouse$cellclusters) | grepl("DGG", meta_sp_l$mouse$cellclusters)]))

ccc1 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc1$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/Glut_all_axolotl_mouse_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
mouse_ord = c(paste0("TEGLU", c(18,19,5,13,14,21,24,23)), "DGGRC2", "DGGRC1", 
              paste0("TEGLU", c(15,17,16, 20,3,2, 7,8,10,11,
                              4,9,1,6, 12,22)))
...
write.csv(plot_df, 
           file = "results/ComparativeSpeciesAnalysis/Glut_all_axolotl_mouse_tab.csv", 
           col.names = T, row.names = F, quote = F)
...
write.csv(ccc1$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/Glut_TFs_axolotl_mouse_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(plot_df, 
           file = "results/ComparativeSpeciesAnalysis/Glut_TFs_axolotl_mouse_tab.csv", 
           col.names = T, row.names = F, quote = F)
...
ccc1 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use, 
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc1$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/GABA_all_axolotl_mouse_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
ccc1 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use, gene_filter = tfs,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc1$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/GABA_TFs_axolotl_mouse_genes.csv", 
          col.names = T, row.names = F, quote = F)

pdf("results/ComparativeSpeciesAnalysis/axolotl_vs_mouse_GABAergicTE_TF.pdf", 
    height = 5, width = 6.5)
plotCorr(ccc1, "axolotl", "mouse")
dev.off()
```

All GABAergic more specific with mouse, TFs only
...
ccc1 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use, 
                       gene_filter = tfs, sp_pair = c("axolotl", "mouse"), 
                       ct_sets = ct_sets, norm_all = F)
...
write.csv(plot_df, 
           file = "results/ComparativeSpeciesAnalysis/GABA_TFs_axolotl_mouse_tab.csv", 
           col.names = T, row.names = F, quote = F)

pdf("results/ComparativeSpeciesAnalysis/axolotl_vs_mouse_GABAergic_TF.pdf", 
    height = 6, width = 15)
plotCorr(ccc1, "axolotl", "mouse")
dev.off()
```
...
Axolotl GABAergic and npc correlation
...
cond_axo = meta_sp_l$axolotl$cellclusters %in% c("npc_SUBSET_5", "npc_SUBSET_6", 
                                                 "npc_SUBSET_8", "npc_SUBSET_10",
                                                 "npc_SUBSET_12")
cond_axo2 = (meta_sp_l$axolotl$subclasses=="GABAergic")
...
pdf("results/ComparativeSpeciesAnalysis/axolotl_GABA_npc.pdf", height = 4, width = 2.8)
pheatmap::pheatmap(t(ccc1$r), clustering_method = "ward.D", 
                   treeheight_row = 30, treeheight_col = 20, fontsize = 6,
                   fontsize_row = 7, fontsize_col = 7, color = cols)
dev.off()
...
cond_axo = meta_sp_l$axolotl$cellclusters %in% c("npc_SUBSET_5", "npc_SUBSET_6", "npc_SUBSET_8",
                                                 "npc_SUBSET_10", "npc_SUBSET_12",
                                                 "npc_SUBSET_0", "npc_SUBSET_1", "npc_SUBSET_2",
                                                 "npc_SUBSET_3", "npc_SUBSET_4", "npc_SUBSET_7",
                                                 "npc_SUBSET_9", "npc_SUBSET_11",
                                                 "npc_SUBSET_13")
glut_axo = (meta_sp_l$axolotl$subclasses=="Glutamatergic" & 
              meta_sp_l$axolotl$cellclusters!="glut_SUBSET_23")
gaba_cond = (meta_sp_l$axolotl$subclasses=="GABAergic")
cond_axo2 = (gaba_cond | glut_axo)
...
pdf("results/ComparativeSpeciesAnalysis/axolotl_neu_npc.pdf", height = 6.25, width = 3.5)
pheatmap::pheatmap(t(ccc1$r), clustering_method = "ward.D", 
                   treeheight_row = 30, treeheight_col = 20, fontsize = 6,
                   fontsize_row = 6.8, fontsize_col = 6.8, color = cols)
dev.off()
```
...
ccc1 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc1$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/VSVZsc_all_axolotl_mouse_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/NBEpen_all_axolotl_mouseVSVZsc_tab.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/VSVZsn_all_axolotl_mouse_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
ccc1 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use, gene_filter = tfs,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc1$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/VSVZsc_TFs_axolotl_mouse_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/NBEpen_TFs_axolotl_mouseVSVZsc_tab.csv", 
          col.names = T, row.names = F, quote = F)
...
ccc2 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use, gene_filter = tfs,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/VSVZsn_TFs_axolotl_mouse_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
NPC and ependymal only, adult neurogenesis, no cell cycle
...
cc_genes = c(Seurat::cc.genes.updated.2019$s.genes, Seurat::cc.genes.updated.2019$g2m.genes,
             Seurat::cc.genes$s.genes, Seurat::cc.genes$g2m.genes)
cc_genes = unique(cc_genes)

mm.pairs = readRDS(system.file("exdata", "mouse_cycle_markers.rds", package="scran"))
hs.pairs = readRDS(system.file("exdata", "human_cycle_markers.rds", package="scran"))
hscc = unique(unlist(lapply(hs.pairs, function(x) c(x$first, x$second))))
hscc = gprofiler2::gconvert(hscc, organism = "hsapiens", target = "ENSG")
hscc = unique(c(hscc$target, hscc$name))
mmcc = unique(unlist(lapply(mm.pairs, function(x) c(x$first, x$second))))
mmcc = gprofiler2::gconvert(mmcc, organism = "mmusculus", target = "ENSG")
mmcc = unique(c(mmcc$target, mmcc$name))

cc_genes = c(cc_genes, mmcc, hscc)


ccc1n = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
ccc1 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F,
                      genes_rem = cc_genes)

pdf("results/ComparativeSpeciesAnalysis/axolotl_vs_mouseVSVZsc_noCC.pdf", height = 4.75, width = 6.1)
plotCorr(ccc1, "axolotl", "mouse")
dev.off()
```
...
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/All_all_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
ccc2 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/NPCEp_all_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/NBEpen_all_axolotl_mouseDiBella_tab.csv", 
          col.names = T, row.names = F, quote = F)
...
ccc2 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/NPCEpvAll_all_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/All_TFs_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/NPCEp_TFs_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/NBEpen_TFs_axolotl_mouseDiBella_tab.csv", 
          col.names = T, row.names = F, quote = F)
...
ccc2 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                       gene_filter = tfs, sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/NPCEpvAll_TFs_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
...
NPC and ependymal only, dev neurogenesis, all stages
...
ccc2 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), norm_all = F)
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/Allstg_all_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
pdf("results/ComparativeSpeciesAnalysis/axolotl_vs_mouseDiBella_celcl_all.pdf", height = 14, width = 6.5)
plotCorr(ccc2, "axolotl", "mouse")
dev.off()
...
ct_sets = list(
  axolotl = unique(dev_meta_l$axolotl$cellclusters[startsWith(dev_meta_l$axolotl$cellclusters,"epen") | 
                                                     startsWith(dev_meta_l$axolotl$cellclusters,"npc")]),
  mouse = unique(dev_meta_l$mouse_all$cellclusters[!(grepl("Microglia", dev_meta_l$mouse_all$classes) |
                                                   grepl("Vasculature", dev_meta_l$mouse_all$classes) |
                                                   grepl("Interneurons", dev_meta_l$mouse_all$classes) |
                                                   grepl("Excitatory neurons", dev_meta_l$mouse_all$classes) |
                                                   grepl("Oligodendrocytes", dev_meta_l$mouse_all$subclasses) |
...
ccc2 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/NPCEpstg_all_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
pdf("results/ComparativeSpeciesAnalysis/axolotl_vs_mouseDiBella_celcl_NPCEp.pdf", height = 8, width = 4.3)
plotCorr(ccc2, "axolotl", "mouse")
dev.off()
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/NBEpenStg_all_axolotl_mouseDiBella_tab.csv", 
          col.names = T, row.names = F, quote = F)
...
ccc2 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use,
                      sp_pair = c("axolotl", "mouse"), ct_sets = ct_sets, norm_all = F)
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/NPCEpvAllstg_all_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
pdf("results/ComparativeSpeciesAnalysis/axolotl_vs_mouseDiBella_celcl_NPCEpvAll.pdf", height = 8, width = 6.5)
plotCorr(ccc2, "axolotl", "mouse")
dev.off()
```

NPC and ependymal only, dev neurogenesis, all stages, TFs
...
ccc2 = corrCellTypesPW(means_list = m, pwde_list = pwde, ort_l = ort_list_use, 
                       ...
                       ct_sets = ct_sets, norm_all = F)
write.csv(ccc2$gene_set, 
          file = "results/ComparativeSpeciesAnalysis/genes_used_correlations/NPCEpstg_TFs_axolotl_mouseDiBella_genes.csv", 
          col.names = T, row.names = F, quote = F)
pdf("results/ComparativeSpeciesAnalysis/axolotl_vs_mouseDiBella_celcl_NPCEp_TFs.pdf", height = 8, width = 7)
plotCorr(ccc2, "axolotl", "mouse")
dev.off()
...
write.csv(plot_df, 
          file = "results/ComparativeSpeciesAnalysis/NBEpenStg_TFs_axolotl_mouseDiBella_tab.csv", 
          col.names = T, row.names = F, quote = F)
```
