...
dataset = readRDS("data/expression/axolotl_nuclei_filtered_annotated.RDS")
meta = read.csv("data/annotations/axolotl_nuc_umeta.csv", header = T, row.names = 1)
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/axolotlNuc_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/axolotlNuc_avgExp.RDS")
