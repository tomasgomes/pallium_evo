...
dataset = readRDS("data/expression/bfinch_seurat.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/bfinch_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/bfinch_avgExp.RDS")
