...
dataset = readRDS("data/expression/drerio_brain_v3.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/drerio_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/drerio_avgExp.RDS")
