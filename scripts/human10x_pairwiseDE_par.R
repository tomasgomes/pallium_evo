...
dataset = readRDS("data/expression/human_10x.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/human10x_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/human10x_avgExp.RDS")
