...
dataset = readRDS("data/expression/human_SS.RDS")
meta = read.csv("data/annotations/humanSS_all_umeta.csv", header = T, row.names = 1)
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/humanSS_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/humanSS_avgExp.RDS")
