...
dataset = readRDS("data/expression/lizard_all_v3.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/lizard_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/lizard_avgExp.RDS")
