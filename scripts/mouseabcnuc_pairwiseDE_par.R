...
dataset = readRDS("data/expression/nuc_dat.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/mouseabcnuc_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/mouseabcnuc_avgExp.RDS")