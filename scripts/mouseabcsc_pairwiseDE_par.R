...
dataset = readRDS("data/expression/sc_dat.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/mouseabcsc_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/mouseabcsc_avgExp.RDS")