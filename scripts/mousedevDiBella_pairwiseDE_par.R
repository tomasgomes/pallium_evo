...
dataset = readRDS("data/expression/mouse_dibella_filt.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/mousedevDiBella_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/mousedevDiBella_avgExp.RDS")
