...
dataset = readRDS("data/expression/mousedev_filt.RDS")
meta = read.csv("data/annotations/mousedev_umeta.csv", header = T, row.names = 1)
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/mousedev_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/mousedev_avgExp.RDS")
