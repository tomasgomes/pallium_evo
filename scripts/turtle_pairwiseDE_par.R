...
dataset = readRDS("data/expression/turtle_all_v3.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/turtle_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/turtle_avgExp.RDS")
