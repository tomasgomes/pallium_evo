...
dataset = readRDS("data/expression/zfinch_seurat.RDS")
...
# save results
saveRDS(mk_list, file = "results/pairwiseDE/zfinch_markers.RDS")
saveRDS(avg_exp, file = "results/pairwiseDE/zfinch_avgExp.RDS")
